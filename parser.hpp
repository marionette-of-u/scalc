...
private:
    ...
    {
        switch(nonterminal_index){
        case 2: return push_stack(&parser::state_13, &parser::gotof_13, v);
        default: assert(0); return false;
        }
    }
    ...
    bool gotof_10(int nonterminal_index, const value_type& v)
    {
        switch(nonterminal_index){
        case 2: return push_stack(&parser::state_20, &parser::gotof_20, v);
        case 3: return push_stack(&parser::state_35, &parser::gotof_35, v);
        default: assert(0); return false;
        }
    }
    ...
    {
        switch(nonterminal_index){
        case 1: return push_stack(&parser::state_8, &parser::gotof_8, v);
        default: assert(0); return false;
        }
    }
    ...
    {
        switch(nonterminal_index){
        case 4: return push_stack(&parser::state_31, &parser::gotof_31, v);
        case 5: return push_stack(&parser::state_30, &parser::gotof_30, v);
        default: assert(0); return false;
        }
    }
