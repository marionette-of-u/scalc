...
private:
    ...
    bool gotof_0(int nonterminal_index, const value_type& v)
    {
        ...
        case 2: return push_stack(&parser::state_9, &parser::gotof_9, v);
    ...
    {
        switch(nonterminal_index){
        case 3: return push_stack(&parser::state_7, &parser::gotof_7, v);
    ...
    {
        switch(nonterminal_index){
        case 2: return push_stack(&parser::state_5, &parser::gotof_5, v);
        default: assert(0); return false;
        }
    }
    ...
    bool state_5(token_type token, const value_type& value)
    {
        ...
        case token_comma:
        case token_0:
            return call_0_make_equality(4, 3, 0, 2);
        default:
            sa_.syntax_error();
            error_ = true;
            return false;
    ...
    bool state_6(token_type token, const value_type& value)
    {
        ...
        case token_comma:
        case token_0:
            return call_0_make_equality_sequence(3, 1, 0);
        default:
            sa_.syntax_error();
            error_ = true;
            return false;
    ...
    bool state_8(token_type token, const value_type& value)
    {
        ...
        case token_comma:
        case token_0:
            return call_1_make_equality_sequence(3, 3, 0, 2);
        default:
            sa_.syntax_error();
            error_ = true;
            return false;
